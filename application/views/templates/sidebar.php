     ...
     <li class="treeview">
        <a href="#">
           ...
           <span class="pull-right-container">
            <i class="fa fa-angle-left pull-right"></i>
           <ul class="treeview-menu">
             <li><a href="<?php echo base_url();?>equipments/new-equipments"><i class="fa fa-circle-o"></i>New Equipments</a></li>
             <li><a href="<?php echo base_url();?>equipments/new-equipment-unit"><i class="fa fa-circle-o"></i>New Units</a></li>
             <li><a href="<?php echo base_url();?>equipments/manage"><i class="fa fa-circle-o"></i>Manage</a></li>
